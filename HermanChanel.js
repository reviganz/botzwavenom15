...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Venom Botz*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             kurr.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/LZlPZEVqK3KGKgL5WVtV2h', "groupName": `OFFICIAL Venom Botz`, "footerText": "*_©Venom Botz_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_©Venom Botz*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
				...
				for (let ment of mek.message.extendedTextMessage.contextInfo.mentionedJid) {
					if (ment === kurr.user.jid){
                        ...
                        addafk(mek.key.remoteJid)
						heheh = ms(Date.now() - waktuafk)
			       sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Venom Botz_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
					}
				}
						}
					}
...
reply(String(e))
    ...
    if (isGroup && isAntivirtex && !mek.key.fromMe) {
      if (budy.length > 2500) {
        ...
        reply("☕ANTIVIRTEX DETECTED!! GOBLOK SEND VIRTEX AUTO DIKICK BODO AMAT");
        ...
        if (budy.includes("wa.me/","https://wa.me//","https://wa.me/")) {
        	if (!mek.key.fromMe){
				...
				if (isGroupAdmins) return reply('☕Atasan grup mah bebas yakan :v mastah ya gan🗿')
				kurr.updatePresence(from, Presence.composing)
				var kic = `${sender.split("@")[0]}@s.whatsapp.net`
				reply('☕Wa.me terdeteksi Auto kick GOBLOK SEND Wa.me DIBILANGIN FITUR Wa.me SDH DI AKTIF KAN TOD!')
        ...
        if (isMuted){
            ...
            if (budy.toLowerCase().startsWith(`${prefix}unmute`)){
                ...
                reply('☕Bot telah diunmute di group ini santuy mastah 🗿')
            }
        }
        if (budy.includes("https://chat.whatsapp.com/")) {
        	if (!mek.key.fromMe){
				...
				kurr.updatePresence(from, Presence.composing)
				var kic = `${sender.split("@")[0]}@s.whatsapp.net`
				reply('Link terdeteksi, Auto kick GOBLOK SEND LINK BACA PERATURAN GROUP BG TOD!')
			    kurr.groupRemove(from, [kic]).catch((e) => { sticNotAdmin(from) })
			}
			}
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© ☕Venom Botz_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('https://instagram.com/reviganz FOLLOW BG GA FOLLOW BOT GA MANEN')
}
if(isButton == 'ytm'){
reply('https://youtu.be/WBFLX3d2WOw SUBSCRIBE DONG JANGAN PAKAI BOT DOANG GA SUBS BOT GA MANEN/')
}
   ...
   const sotoy = [
		...
		//runtime berjalan
           runi = process.uptime() 
           kurr.setStatus(`ℒ⃝🐋Bot Active tod 🗿 klo mo sewa bot ketik #owner ya ||©Creator Revi Ganz || ||Spam/vc Block permanent tod dan nowa anda akan saya ban permanet||Bot On kack & waktu berjalan venom botz... ${kyun(runi)} `).catch((_)=>_);
...
{buttonId:`script`,buttonText:{displayText:'ℒ⃝🐋SEWABOTℒ⃝🐋'},type:1}
]
...
"thumbnail": pporigi,
       ...
       menu = `┌───「 \`\`\`Venom Botz\`\`\` 」
│
ℒ⃝🐋 _Creator : *ReviGanz* 
ℒ⃝🐋 _Battery : ${baterai.battery}_
ℒ⃝🐋 _Mode : ${publik ? 'Public' : 'Self'}_
ℒ⃝🐋 _Total Hit : ${cmhit.length}_
ℒ⃝🐋 _Prefix : ${multi ? 'Multi Prefix' : 'No Prefix'}_
│
ℒ⃝🐋───「 \`\`\`INFO BOT\`\`\` 」
│
ℒ⃝🐋 _Nama Bot : Venom Botz_
ℒ⃝🐋 _Nama Owner : ${NamaOwner}_
ℒ⃝🐋 _Nomor Owner : @${otod.split('@')[0]}_
ℒ⃝🐋 _Auto Composing : ${settings.autocomposing}_
ℒ⃝🐋 _Auto Recording : ${settings.autorecording}_
│
ℒ⃝🐋───「 \`\`\`INFO USER\`\`\` 」
│
ℒ⃝🐋 _Status : ${isOwner ? 'Owner' : 'User'}_
ℒ⃝🐋 _Nama : ${pushname}_
ℒ⃝🐋 _Bio : ${stst}_
ℒ⃝🐋 _Nomor : @${stod.split('@')[0]}_
ℒ⃝🐋 _Info Nomor : ${num.data.country_code} - ${num.data.carrier.type} - ${num.data.carrier.name}_
│
└───「 \`\`\`Venom Botz\`\`\` 」`
sendButLocation(from, `${menu}`, "*_© Venom Botz_*", {jpegThumbnail:ofrply,name:""}, [{buttonId:`command`,buttonText:{displayText:'BUTTON MENU'},type:1},{buttonId:`owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`script`,buttonText:{displayText:'SOURCE CODE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'allmenu': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
stod = `${sender}`
       stst = await kurr.getStatus(`${sender.split('@')[0]}@c.us`)
       nama = 'ℒ⃝🇲🇨VENOM BOTℒ⃝🇲🇨'
       ownerJid = "6287772961550@s.whatsapp.net"
				stst = stst.status == 401 ? '' : stst.status
...
│
ℒ⃝🐋─❲ OWNER ❳─ℒ⃝🐋ツ
ℒ⃝🐋 ${prefix}autorespon [ _on/off_ ]
ℒ⃝🐋 ${prefix}antidelete [ _on/off_ ]
ℒ⃝🐋 ${prefix}bc [ _teks/reply gif/image/video with caption_ ]
ℒ⃝🐋 ${prefix}tobc [ _reply sticker/audio with caption_ ]
ℒ⃝🐋 ${prefix}return [ _javascript_ ]
ℒ⃝🐋 ${prefix}clearall
ℒ⃝🐋 ${prefix}delchat
ℒ⃝🐋 ${prefix}mute
ℒ⃝🐋 ${prefix}unmute
ℒ⃝🐋 ${prefix}public
ℒ⃝🐋 ${prefix}self
ℒ⃝🐋 ${prefix}spam [ _teks|jumlah_ ]
ℒ⃝🐋 ${prefix}demoteall
ℒ⃝🐋 ${prefix}promoteall
ℒ⃝🐋 ${prefix}addcmd [ _teks reply stc_ ]
ℒ⃝🐋 ${prefix}delcmd [ _reply stc_ ]
ℒ⃝🐋 ${prefix}listcmd
ℒ⃝🐋 ${prefix}spamsw [ _teks|jumlah_ ]
ℒ⃝🐋 ${prefix}upswteks [ _teks_ ]
ℒ⃝🐋 ${prefix}upswlokasi [ _teks_ ]
ℒ⃝🐋 ${prefix}upswaudio [ _reply audio_ ]
ℒ⃝🐋 ${prefix}upswvoice [ _reply audio_ ]
ℒ⃝🐋 ${prefix}upswsticker [ _reply sticker_ ]
ℒ⃝🐋 ${prefix}upswimage [ _reply image with caption_ ]
ℒ⃝🐋 ${prefix}upswgif [ _reply gif with caption_ ]
ℒ⃝🐋 ${prefix}upswvideo [ _reply video with caption_ ]
ℒ⃝🐋 ${prefix}shutdown
ℒ⃝🐋 ${prefix}offline [ _alasan_ ]
ℒ⃝🐋 ${prefix}online
ℒ⃝🐋 ${prefix}exif [ _nama|author_ ]
ℒ⃝🐋 ${prefix}setprofile [ _reply image_ ]
ℒ⃝🐋 ${prefix}setname [ _teks_ ]
ℒ⃝🐋 ${prefix}setprefix [ _multi/nopref/prefix_ ]
ℒ⃝🐋 ${prefix}setbio [ _teks_ ]
ℒ⃝🐋 ${prefix}leave
ℒ⃝🐋 ${prefix}restart
ℒ⃝🐋 ${prefix}addrespon [ _tanya|jawab_ ]
ℒ⃝🐋 ${prefix}delrespon [ _nama_ ]
ℒ⃝🐋 ${prefix}listrespon
ℒ⃝🐋 ${prefix}readall
ℒ⃝🐋 ${prefix}unreadall
ℒ⃝🐋 ${prefix}archive
ℒ⃝🐋 ${prefix}unarchiveall
ℒ⃝🐋 ${prefix}pin
ℒ⃝🐋 ${prefix}unpin
ℒ⃝🐋 ${prefix}setmenu [ _ori/simpel_ ]
ℒ⃝🐋 ${prefix}setallmenu [ _ori/simpel_ ]
ℒ⃝🐋 ${prefix}leavetime [ _detik/menit/jam_ ]
ℒ⃝🐋 ${prefix}bukatime [ _detik/menit/jam_ ]
ℒ⃝🐋 ${prefix}tutuptime [ _detik/menit/jam_ ]
ℒ⃝🐋 ${prefix}nano [ _nama file_ ]
│
ℒ⃝🐋─❲ NEW ❳─ℒ⃝🐋ツ
ℒ⃝🐋 ${prefix}jadibot
ℒ⃝🐋 ${prefix}stopjadibot
│
ℒ⃝🐋─❲ DOWNLOAD ❳─ℒ⃝🐋ツ
ℒ⃝🐋 ${prefix}infogempa
ℒ⃝🐋 ${prefix}herolist
ℒ⃝🐋 ${prefix}herodetail [ _hero_ ]
ℒ⃝🐋 ${prefix}google [ _search_ ]
ℒ⃝🐋 ${prefix}gimage [ _search_ ]
ℒ⃝🐋 ${prefix}wiki [ _search_ ]
ℒ⃝🐋 ${prefix}mediafire [ _link_ ]
ℒ⃝🐋 ${prefix}ytsearch [ _judul_ ]
ℒ⃝🐋 ${prefix}ytmp4 [ _link yt_ ]
ℒ⃝🐋 ${prefix}ytmp3 [ _link yt_ ]
ℒ⃝🐋 ${prefix}play [ _judul lagu_ ]
ℒ⃝🐋 ${prefix}video [ _judul video_ ]
ℒ⃝🐋 ${prefix}tinyurl [ _link_ ]
ℒ⃝🐋 ${prefix}fetch [ _link_ ]
ℒ⃝🐋 ${prefix}igdl [ _link_ ]
ℒ⃝🐋 ${prefix}tiktokdl [ _link_ ]
ℒ⃝🐋 ${prefix}pinterest [ _search_ ]
ℒ⃝🐋 ${prefix}lirik [ _judul_ ]
ℒ⃝🐋 ${prefix}tourl [ _reply image/video_ ]
ℒ⃝🐋 ${prefix}resepmasakan [ _judul_ ]
ℒ⃝🐋 ${prefix}artimimpi [ _teks_ ]
ℒ⃝🐋 ${prefix}bilangangka [ _angka_ ]
ℒ⃝🐋 ${prefix}kalkulator [ _angka_ ]
ℒ⃝🐋 ${prefix}fancytext [ _teks_ ]
ℒ⃝🐋 ${prefix}githubstalk [ _username_ ]
ℒ⃝🐋 ${prefix}translate [ _teks kodebhs_ ]
ℒ⃝🐋 ${prefix}ss [ _link_ ]
ℒ⃝🐋 ${prefix}playstore [ _search_ ]
ℒ⃝🐋 ${prefix}tiktokaudio [ _link_ ]
ℒ⃝🐋 ${prefix}brainly [ _search_ ]
ℒ⃝🐋 ${prefix}igstory [ _search_ ]
ℒ⃝🐋 ${prefix}igstalk [ _link_ ]
ℒ⃝🐋 ${prefix}twitter [ _link_ ]
ℒ⃝🐋 ${prefix}twmp3 [ _link_ ]
ℒ⃝🐋 ${prefix}linkwa [ _search_ ]
ℒ⃝🐋 ${prefix}fb [ _link_ ]
ℒ⃝🐋 ${prefix}chara [ _search_ ]
ℒ⃝🐋 ${prefix}otaku [ _search_ ]
ℒ⃝🐋 ${prefix}komiku [ _search_ ]
│
ℒ⃝🐋─❲ MAKER ❳─ℒ⃝🐋ツ
ℒ⃝🐋 ${prefix}foliokanan [ _text_ ]
ℒ⃝🐋 ${prefix}foliokiri [ _text_ ]
ℒ⃝🐋 ${prefix}nuliskanan [ _text_ ]
ℒ⃝🐋 ${prefix}nuliskiri [ _text_ ]
ℒ⃝🐋 ${prefix}maker3d [ _text_ ]
ℒ⃝🐋 ${prefix}maker2d [ _text_ ]
ℒ⃝🐋 ${prefix}epepserti [ _text_ ]
│
ℒ⃝🐋─❲ GROUP ❳─ℒ⃝🐋ツ
ℒ⃝🐋 ${prefix}getpict [ _@tag_ ]
ℒ⃝🐋 ${prefix}getname [ _reply target_ ]
ℒ⃝🐋 ${prefix}getbio [ _reply target_ ]
ℒ⃝🐋 ${prefix}promote [ _@tag_ ]
ℒ⃝🐋 ${prefix}demote [ _@tag_ ]
ℒ⃝🐋 ${prefix}antilink [ _on/off_ ]
ℒ⃝🐋 ${prefix}antivirtex [ _on/off_ ]
ℒ⃝🐋 ${prefix}antiwame [ _on/off_ ]
ℒ⃝🐋 ${prefix}antibug [ _on/off_ ]
ℒ⃝🐋 ${prefix} welcome [ _on/off_ ]
ℒ⃝🐋 ${prefix}creategrup [ _nama|@tag_ ]
ℒ⃝🐋 ${prefix}tictactoe [ _@tag_ ]
ℒ⃝🐋 ${prefix}delttt
ℒ⃝🐋 ${prefix}getpp
ℒ⃝🐋 ${prefix}antiwame
ℒ⃝🐋 ${prefix}getdeskgc
ℒ⃝🐋 ${prefix}sider [ _reply pesan bot_ ]
ℒ⃝🐋 ${prefix}hacked [ _teks_ ]
ℒ⃝🐋 ${prefix}setnamegc [ _teks_ ]
ℒ⃝🐋 ${prefix}setdeskgc [ _teks_ ]
ℒ⃝🐋 ${prefix}fitnah [ _@tag|teks1|teks2_ ]
ℒ⃝🐋 ${prefix}kontak [ _@tag|nama_ ]
ℒ⃝🐋 ${prefix}kontag [ _@tag|nama_ ]
ℒ⃝🐋 ${prefix}opengc
ℒ⃝🐋 ${prefix}closegc
ℒ⃝🐋 ${prefix}resetlinkgc
ℒ⃝🐋 ${prefix}linkgrup
ℒ⃝🐋 ${prefix}hidetag [ _teks_ ]
ℒ⃝🐋 ${prefix}sticktag [ _nama sticker_ ]
ℒ⃝🐋 ${prefix}totag [ _reply media_ ]
│
ℒ⃝🐋─❲ STICKER ❳─ℒ⃝🐋ツ
ℒ⃝🐋 ${prefix}sticker
ℒ⃝🐋 ${prefix}stickerwm [ _nama|author_ ]
ℒ⃝🐋 ${prefix}takestick [ _nama|author_ ]
ℒ⃝🐋 ${prefix}colong [ _reply sticker_ ]
ℒ⃝🐋 ${prefix}dadu
ℒ⃝🐋 ${prefix}semoji [ _emoji_ ]
ℒ⃝🐋 ${prefix}attp [ _teks_ ]
ℒ⃝🐋 ${prefix}toimg
ℒ⃝🐋 ${prefix}tomp3 [ _reply video_ ]
ℒ⃝🐋 ${prefix}tomp4 [ _reply sticker gif_ ]
ℒ⃝🐋 ${prefix}robot [ _reply audio_ ]
ℒ⃝🐋 ${prefix}balik [ _reply audio_ ]
ℒ⃝🐋 ${prefix}bass [ _reply audio_ ]
ℒ⃝🐋 ${prefix}gemuk [ _reply audio_ ]
ℒ⃝🐋 ${prefix}detikvn [ _reply audio caption angka_ ]
ℒ⃝🐋 ${prefix}detikvideo [ _reply video caption angka_ ]
│
ℒ⃝🐋─❲ ASUPAN ❳─ℒ⃝🐋ツ
ℒ⃝🐋 ${prefix}asupan
ℒ⃝🐋 ${prefix}asupan2
...
ℒ⃝🐋─❲ STORAGE ❳─ℒ⃝🐋ツ
ℒ⃝🐋 ${prefix}listimage
ℒ⃝🐋 ${prefix}liststicker
ℒ⃝🐋 ${prefix}listvn
ℒ⃝🐋 ${prefix}addsticker [ _nama_ ]
ℒ⃝🐋 ${prefix}delsticker [ _nama_ ]
ℒ⃝🐋 ${prefix}addvn [ _nama_ ]
ℒ⃝🐋 ${prefix}delvn [ _nama_ ]
ℒ⃝🐋 ${prefix}addimage [ _nama_ ]
ℒ⃝🐋 ${prefix}delimage [ _nama_ ]
│
ℒ⃝🐋─❲ JADI BOT ❳─ℒ⃝🐋ツ
ℒ⃝🐋 ${prefix}stopjadibot
ℒ⃝🐋 ${prefix}jadibot
...
ℒ⃝🐋 ${prefix}apakah
ℒ⃝🐋 ${prefix}bisakah
ℒ⃝🐋 ${prefix}caripesan [ _teks|jumlah_ ]
ℒ⃝🐋 ${prefix}slots
ℒ⃝🐋 ${prefix}suit [ _gunting/batu/kertas_ ]
ℒ⃝🐋 ${prefix}tag [ _nomor_ ]
ℒ⃝🐋 ${prefix}tagme
ℒ⃝🐋 ${prefix}tts [ _kodebhs teks_ ]
ℒ⃝🐋 ${prefix}readmore [ _teks1|teks2_ ]
ℒ⃝🐋 ${prefix}fitnahpc [ _nomor|teks1|teks2_ ]
ℒ⃝🐋 ${prefix}chat [ _nomor|teks_ ]
ℒ⃝🐋 ${prefix}fdeface [ _replyimg link|teks1|teks2_ ]
ℒ⃝🐋 ${prefix}listgrup
ℒ⃝🐋 ${prefix}baileys [ _reply message_ ]
ℒ⃝🐋 ${prefix}q [ _reply message_ ]
ℒ⃝🐋 ${prefix}getcaption [ _reply message_ ]
ℒ⃝🐋 ${prefix}pantun
ℒ⃝🐋 ${prefix}tospam [ _reply audio/sticker/image|jumlah_ ]
ℒ⃝🐋 ${prefix}sharelock [ _teks1|teks2_ ]
└─⊰᯽⊱┈────╌❊╌───┈⊰᯽⊱
`
if(menuall == false){
   //Masih langka
...
break
        case 'ig':
        reply('https://instagram.com/reviganz\nFOLOW BANG')
        break
case 'verify':
...
{buttonId:`donasi`,buttonText:{displayText:'SEDEKAH BG🗿'},type:1}
]
mhan = await kurr.prepareMessage(from, ofrply, image, {thumbnail: ofrply})
const sendBtnVeryy = {
imageMessage: mhan.message.imageMessage,
...
ini_list.push({
"displayName": `Developer Venom Botz`,
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Script Venom Botz Chanel`,
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(12)
                    kurr.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`Venom Botz`}, MessageType.location)
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              kurr.groupUpdateSubject(from, `HACKED BY Venom Botz`)
...
for (let i = 0; i < args[0]; i++) {
kurr.sendMessage(from, `Venom Botz`, MessageType.extendedText,{
 quoted: {
key: {
...
kurr.sendMessage(from, `Venom Botz`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
...
Giliran = @${tty.player1.split('@')[0]}`
 kurr.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR KAK MOHON MAFF FITUR MENU ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Venom Botz",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./thumb.jpg'),sourceUrl:"https://wa.me//6287772961550"}}})
	}
    }
    }
    }
