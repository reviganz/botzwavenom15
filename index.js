...
const starts = async (kurr = new WAConnection()) => {
	console.log(color('Go 40 Subscribe Ngabb\n\n', 'orange'), color('\n======TQTO KEPADA======\n•Aldy Fauzy\n•Kemol\nRevi Ganz\n•ADI\n•Venom Botz\n•YUDHA\n•PAJAR\n•Dcode Denpa\n•Finx\n•Subscriber\n•All Creator Botz', 'yellow'))
	console.log(color('\n\nSUBSCRIBE LAH JAN MAKE DOANG ©YT EDIT 3D GO40SUBS', 'pink'))
    kurr.logger.level = 'warn'
    kurr.version = [2, 2143, 3]
    kurr.browserDescription = [ 'VENOM BOTZ V7', 'Chrome', '3.0' ]
    ...
    kurr.on('chat-update', async (message) => {
        ...
        ownerNumber = ["6287772961550@s.whatsapp.net","6283146208804@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "6287772961550@s.whatsapp.net"
...
sendButImage(mdata.id, teks, 'Jangan Melanggar peraturan group ini kak🌚', img, [{buttonId: 'mam', buttonText: {displayText: 'Welcome kak 👋'}, type: 1},{buttonId: '!sc', buttonText: {displayText: 'Moga Betah Ya️'}, type: 1}], {thumbnail: img, "contextInfo": {mentionedJid: [num]}, quoted: {"key": {"fromMe": false,"participant": "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "62895619083555-1616169743@g.us","inviteCode": "mememteeeekkeke","groupName": "P", "caption": `subscribe : xZiyy`, 'jpegThumbnail': fs.readFileSync('./media/thumb.jpg')}}}})
...
sendButImage(mdata.id, teks, 'Member Grup Berkurang 1🗿', buffa, [{buttonId: 'X - Dev Team', buttonText: {displayText: 'Bye 👋'}, type: 1}], {thumbnail: buffa, "contextInfo": {mentionedJid: [num]}, quoted: {"key": {"fromMe": false,"participant": "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "62895619083555-1616169743@g.us","inviteCode": "mememteeeekkeke","groupName": "P", "caption": `subscribe : xZiyy`, 'jpegThumbnail': fs.readFileSync('./media/thumb.jpg')}}}})
}
